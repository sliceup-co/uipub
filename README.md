...
```bash
yarn create react-app your-project-Template --Template must-have-libraries
```

Or;

```bash
npx create-react-app your-project-Template --Template must-have-libraries
```
...
const AppRouter: FunctionComponent = () => {
  return (
    <Profiler onRender={(Template_id, phase, actualTime, baseTime, startTime, commitTime) => {
      console.log(`${Template_id}'s ${phase} phase:`);
